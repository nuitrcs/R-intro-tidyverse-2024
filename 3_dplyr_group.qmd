...
What proportion of vehicles are Toyotas? (vehicle_make "TOYT")
...
Instead of using slice by itself, we're more likely to want to use slice_max or slice_min, or combine slice with sorting the rows in a particular order. Let's see how to do that.
...
First, how do we get actual date and times we can work with?
