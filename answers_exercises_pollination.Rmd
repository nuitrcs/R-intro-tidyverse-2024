---
title: "Answers to pollination exercises"
author: "Haley Carter"
date: "2023-07-10"
...
In 2009, in which population did researchers spend the most observation time? How much time did researchers spend per observation in each population?

Note: The names of the columns are different between firstyear_data and dc_data.

```{r}
firstyear_data %>% 
  group_by(PopName) %>% 
  summarize(observation_time = sum(ObsevTime),
            time_per_obs = sum(ObsevTime)/n())
...
We want to know if bees or hawkmoths are more common visitors to these flowers. In DC, how often were there more hawkmoths than bees at an individual plants? How often were there more bees than hawkmoths?
